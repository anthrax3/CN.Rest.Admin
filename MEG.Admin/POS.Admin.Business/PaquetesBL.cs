        ...
        public string setPaquetes(Paquetes paquetes, Objetos.TipoTransaccion tipoTransaccion, string empresaID)
        {
            ...
            switch (tipoTransaccion)
            {
                case Objetos.TipoTransaccion.INSERT:
                    ...
                    {
                        if (paquetesDL.genera_paquete(paquetes, "ins_paqueteVr2", empresaID) > 0)
                ...
                case Objetos.TipoTransaccion.UPDATE:
                    if (paquetesDL.genera_paquete(paquetes, "upd_paqueteVr2", empresaID) > 0)
        ...
        public string setCombinaciones(Combinaciones combinaciones, Objetos.TipoTransaccion tipoTransaccion, string empresaID)
        {
            ...
            switch (tipoTransaccion)
            {
                case Objetos.TipoTransaccion.INSERT:
                    ...
                    {
                        if (paquetesDL.genera_combinacion(combinaciones, "ins_combinacionVr2", empresaID) > 0)
                    ...
                    break;
                case Objetos.TipoTransaccion.UPDATE:
                    if (paquetesDL.genera_combinacion(combinaciones, "upd_combinacionVr2", empresaID) > 0)
