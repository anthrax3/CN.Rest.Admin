...
namespace POS.Admin.Identities
{
    public class PedidosProveedor
    {
        public PedidosProveedor()
        {
            ...
            pedidoProveedorDetalle = new List<PedidoProveedorDetalle>();
        }
        ...
        public List<PedidoProveedorDetalle> pedidoProveedorDetalle = new List<PedidoProveedorDetalle>();
    }

    public class PedidoProveedorDetalle
    {
        public PedidoProveedorDetalle()
        {
            _id = string.Empty;
            _pedidoID = string.Empty;
            _ean = string.Empty;
