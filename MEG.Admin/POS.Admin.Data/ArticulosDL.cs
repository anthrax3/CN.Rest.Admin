...
namespace POS.Admin.Data
{
    public class ArticulosDL
    {
        ...
        public int genera_articulo(Articulos articulos, string strProc, string empresaID)
        {
            ...
            Parameters.type = "Decimal";
            Parameters.size = "10";
            Parameters.value = articulos.distribuidor.Trim();
            listParameters.Add(Parameters);
            ...
            Parameters.type = "Int32";
            Parameters.size = "1";
            Parameters.value = (articulos.principal.ToLower() == "true") ? "1" : "0";
            listParameters.Add(Parameters);
        ...
        public string ins_ImagenArticulo(Articulos articulos, string nombre, MemoryStream imagen, string mimeType, bool principal)
        {
            arrayParameters = new WSPOS.ArrayParameters();
            listObjParameter = new List<WSPOS.ObjParameters>();
            ...
            Parameters.type = "VarChar";
            Parameters.size = "150";
            Parameters.value = articulos.id.Trim() + "--" + nombre.Trim();
            listParameters.Add(Parameters);
            ...
            Parameters.type = "Int32";
            Parameters.size = "1";
            Parameters.value = (principal == true) ? "1" : "0";
            listParameters.Add(Parameters);

            objParameter.strProc = "ins_articulo_imagen";
            objParameter.ListParameters = listParameters.ToArray();
            listObjParameter.Add(objParameter);
            ...
            if (value > 0)
            {
                WSPOS.Formats formats;

                switch (mimeType)
                {
                    case "Png":
                        formats = WSPOS.Formats.Png;
                        break;
                    case "Jpeg":
                        formats = WSPOS.Formats.Jpeg;
                        break;
                    case "Gif":
                        formats = WSPOS.Formats.Gif;
                        break;
                    case "Bmp":
                        formats = WSPOS.Formats.Bmp;
                        break;
                    default:
                        formats = WSPOS.Formats.Jpeg;
                        break;
                ...
                respuesta = service.setImage(imagen.ToArray(), "", articulos.id.Trim() + "--" + nombre.Trim(), formats);
            }
            else
            {
                respuesta = "No se pudo agregar imagen a Base de Datos";
            }
        ...
        public DataTable getImagenArticulos(string articuloID)
        {
            ...
            Parameters.type = "Int32";
            Parameters.size = "11";
            Parameters.value = articuloID.Trim();
            listParameters.Add(Parameters);

            objParameter.strProc = "sel_articulos_imagen";
            objParameter.ListParameters = listParameters.ToArray();
            listObjParameter.Add(objParameter);
        ...
        public string eliminaImagenArticulo(string aImagenID, string nombre)
        {
            ...
            Parameters = new WSPOS.Parameters();
            Parameters.name = "_aImagenID";
            Parameters.type = "Int32";
            Parameters.size = "11";
            Parameters.value = aImagenID.Trim();
            listParameters.Add(Parameters);

            objParameter.strProc = "del_articulos_imagen";
            objParameter.ListParameters = listParameters.ToArray();
            listObjParameter.Add(objParameter);
            ...
            if (value > 0)
            {
                respuesta = service.cleanImage("", nombre);
            }
            else
            {
                respuesta = "No se pudo agregar imagen a Base de Datos";
